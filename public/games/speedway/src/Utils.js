...
export const scaleBasedOnImageByPercent = (parentImgBounds, childImg, xPercent, yPercent) => {
...
export const scaleBasedOnAbsoluteValue = (targetImg, width, height) => {

  return targetImg.setScale(
...
export const checkIfSingleWord = (text) => {
