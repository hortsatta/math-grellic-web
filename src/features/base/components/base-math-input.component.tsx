      ...
      >
        <div className='relative flex min-h-[46px] w-full flex-col'>
          <EditableMathField
            id={newId}
            className={cx(
              `mq-editable-field mq-math-mode peer h-full w-full flex-1 !rounded-md !border-2 !border-accent/40 py-2 pl-18px pr-5 !leading-normal text-accent !outline-none
