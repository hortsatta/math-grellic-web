...
import type { AdminUserAccount } from '#/user/models/user.model';
...
export const AdminUserSingleCard = memo(function ({
  className,
  admin,
  onDetails,
  onEdit,
  ...
  const [statusLabel, statusIconName] = useMemo(() => {
    switch (approvalStatus) {
      case UserApprovalStatus.Approved:
        return ['Registered', 'check-square'];
...
export const AdminUserSingleCardSkeleton = memo(function () {
  return (
